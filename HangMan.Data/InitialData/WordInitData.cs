...
namespace HangMan.Data.InitialData
{
    public class WordsInitData
    {
        public static Word[] DataSeed => new Word[]
        {
            ...
            new Word { WordId = 1, TopicId =1, Text = "Mindaugas"},
            new Word { WordId = 1, TopicId =1, Text = "Vytautas"},
            new Word { WordId = 1, TopicId =1, Text = "Kęstutis"},
            new Word { WordId = 1, TopicId =1, Text = "Algirdas"},
            new Word { WordId = 1, TopicId =1, Text = "Žygimantas"},
            new Word { WordId = 1, TopicId =1, Text = "Birutė"},
            new Word { WordId = 1, TopicId =1, Text = "Barbora"},
            new Word { WordId = 1, TopicId =1, Text = "Augustas"},
